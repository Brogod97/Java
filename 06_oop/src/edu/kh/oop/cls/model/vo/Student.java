...
// 접근 제한자 public: 같은 프로젝트 내에서 어떤 클래스에서든 import 할 수 있음을 나타냄.
	...
	public static String schoolName = "KH정보교욱원";
	
	private String name; // 캡슐화 원칙 private -> 간접 접근 방법이 필요함
	
	{
		// 초기화 블록: 객체 생성 시 빌드 값 초기화
		name = "홍길동";
	}
	...
	public void setName(String name) { // setter는 매개변수를 받아야 함
		this.name = name;
	}
