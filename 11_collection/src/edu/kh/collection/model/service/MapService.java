...
public class MapService {
	...
	// Map : key와 value 한 쌍이 데이터가 되며 이를 모아둔 객체
	...
	public void ex1() {
		...
		// Key 중복
		map.put(1, "중복길동"); // Key 중복 허용은 X, 대신 Value를 덮어씀
		
		// Value 중복
		map.put(7, "육길동"); // Key가 다르면 Value 중복 O
	...
	public void ex2() {
		...
		// value가 Ojbect 타입 == 어떤 객체든 value에 들어올 수 있다.
		...
		// 실행 중 확인해보니 String의 자식 객체 -> 자식 toString() 호출 -> 동적 바인딩
	...
	public void ex3() {
		...
		// for문 종료 시점에 List에는 10개의 Map객체가 추가되어 있다.
