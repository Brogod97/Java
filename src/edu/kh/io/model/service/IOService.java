...
public class IOService {
	...
	public void output1() {
		...
		FileOutputStream fos = null; // 보통 초기값으로 null을 넣고 시작 (FileNotFoundException 방지)
		...
		try {
			...
			for(int i = 0; i < str.length(); i++) {
				// System.out.println(str.charAt(i)); // 콘솔에서 출력 확인
	...
	public void input1() {
		...
		try {
			...
			while(true) {
				...
				// 반복 종료가 안됐으면 char로 강제 현변환 해서 문자로 출력
