...
import edu.kh.objarray.practice.model.vo.EmployeeT;

public class EmployeeServiceT {
	private EmployeeT[] employees = new EmployeeT[3]; // 사원 정보를 저장할 Employee 배열
	...
	public void initEmployee() {
		...
		for(int i = 0; i < employees.length; i++ ) {
			...
			employees[i] = new EmployeeT(empNo, name, group, job, salary);
